...
import cn.yjl.dialoglib.BottomPopupWindow;
import cn.yjl.dialoglib.CustomDialog;
import cn.yjl.dialoglib.EditDialog;
import cn.yjl.dialoglib.EnsureDialog;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showEnsureDialogThree() {
        ensureDialog = new EnsureDialog(this).builder()
                ...
                .setIncon(R.mipmap.ic_record_voice_over_black_48dp)//不设置图标，默认没有图标
                .setCancelable(false)
